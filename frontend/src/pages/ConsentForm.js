...
const ConsentForm = () => {
  ...
  <div className="card-img-overlay">
    ...
    <div className="card-text">
      ...
      <p style={{color:"#A2E4A1", fontSize:25}}>Patient's Information</p>
      <p>
...
<div className="row g-3 mt-1">
<div className="col">
    <input type="number" className="form-control" placeholder="Patient's ID" aria-label="Patient's ID"/>
  </div>
  <div className="col">
    <input type="date" className="form-control" placeholder="Birth Date" aria-label="Birth Date"/>
  </div>
</div>
<div className="mb-3">
  <label htmlfor="exampleFormControlTextarea1" class="form-label"></label>
  <textarea className="form-control" placeholder="Address" id="exampleFormControlTextarea1" rows="2"></textarea>
</div>
<div className="row g-3 mt-1">
  <div className="col">
    <input type="text" className="form-control" placeholder="Gender" aria-label="Gender"/>
  </div>
  <div className="col">
    <input type="number" className="form-control" placeholder="Age" aria-label="Age"/>
  </div>
  <div className="col">
    <input type="number" className="form-control" placeholder="Height" aria-label="Height"/>
  </div>
</div>
<div className="row g-3 mt-1">
  <div className="col">
    <input type="number" className="form-control" placeholder="Mobile No" aria-label="Mobile No"/>
  </div>
  <div className="col">
    <input type="number" className="form-control" placeholder="Home Phone No" aria-label="Home Phone No"/>
  </div>
  </div>
  <div className="row g-3 mt-1">
  <div className="col">
  ...
  <div className="col">
    <input type="email" className="form-control" placeholder="Other mail ID" aria-label="Other mail ID"/>
  </div>
  </div>
  <div className="btn mt-1">
 <a href="#" className="btn btn-dark" style={{color:"white", fontSize:18}}>Next</a> 
</div>

  <div className="page" style={{textAlign:"center" ,fontSize:15, color:"black"}}>1/3</div>
      </p>
          </div>
  </div>
</div>
