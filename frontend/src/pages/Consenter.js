  ...
  return (
    <>
      <div className="bg-gradient-to-bl from-[#4D8470] to-white min-w-screen flex items-center justify-center">
        <div
          className="shadow-md h-[600px] shadow-[#4D8470] rounded-xl border-2 border-[#A2E4A1] bg-gradient-to-t from-[#4D8470] to-[#A2E4A1] transition ease-in-out delay-50 hover:-translate-y-2 duration-500 px-16 py-6"
          ...
          <div className="card bg-dark text-white">
            ...
            <div className="card-img-overlay">
              ...
              <h5
                ...
                style={{ fontSize: 34, color: "#A2E4A1" }}
              >
                Consenter Input Details
              </h5>
              <div className="card-text">
                ...
                <div class="mb-3">
                  <label
                    for="fullName"
                    class="form-label"
                    style={{ color: "#A2E4A1", fontSize: 20 }}
                  >
                    Full Name
                  </label>
