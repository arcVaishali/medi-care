...
const Auth = () => {
  ...
  <div className="card-img-overlay">
    ...
    <div className="card-text" mt-1>
      ...
      <div className="container mt-1" style={{color:"#A2E4A1", fontSize:25}}>MediCare Authorization and Release</div>
      <div className="body3 mt-2">
      <div class="form-check">
  <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"/>
  <label class="form-check-label" htmlFor="flexCheckDefault">
  I give my permission to MediCare services, to provide medical treatment (diagnostic
        and therapeutic procedures) as may be necessary for the patient as requested, and 
  ...
  <label class="input-group-text" for="inputGroupFile02">Upload Signature</label>
</div>
<div className="btn">
  <a href="#" className="btn btn-success" style={{color:"white", fontSize:18}}>Submit</a>
  </div>
        </p>
        <div className="page mt-1" style={{textAlign:"center" ,fontSize:15, color:"white"}}>3/3</div>
